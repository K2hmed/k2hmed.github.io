...
function Modal({ open, onClose, children }) {
  ...
  return createPortal(
    <div className="fixed inset-0 z-[100]">
      ...
      {/* Modal panel */}
      <div className="relative z-[101] mx-auto flex min-h-screen items-center justify-center p-4 sm:p-6">
        <div
          role="dialog"
          aria-modal="true"
          className={cx(
    ...
    <>
      ...
      <Card className="h-full">
        <div className="flex h-full flex-col">
          ...
          <div className="h-40 w-full rounded-2xl bg-surface/60 border border-border/50" />
